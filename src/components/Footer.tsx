      ...
      <div className="p-10 bg-[#F9F9F9] text-30">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2">
            ...
            <div className="mb-5 items-center flex flex-col py-4 mx-auto w-full text-left">
              <div className="pb-4">
            ...
            <div className="mb-5 text-center text-30 text-[18px] font-[400] items-center py-[20px]">
              <ul>
                <li className="hover:text-70 pb-2"><a href="#">Home</a></li>
            ...
            <div className="text-30 items-center py-[20px]">
              <div className="text-[16px] font-[600] pb-4 text-center">
                <span>FOLLOW US ON</span>
              </div>
              <div className="flex mb-7 justify-center gap-[22px]">
            ...
            <div className="text-30 items-center p-auto">
              <div className="text-[20px] font-[500] pb-1 items-center text-center py-[20px]">
                <span>Organized By</span>
              </div>
              <div>
                <a href="#">
                  <img className="pt-[12px] mx-auto" src="/arduino-sl-logo.png"/>
                </a>
              </div>
            </div>
          </div>
